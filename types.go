...
It can then convert that map into a array of strings in the same format as "os.Environ()" provides, and compatible with the "Env" field of the https://golang.org/pkg/os/exec/#Cmd type and the "envv" arg https://golang.org/pkg/syscall/#Exec function.
